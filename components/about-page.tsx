        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-700 text-lg mb-6">
                At Sellah, our mission is clear: to simplify and enhance the selling experience for businesses operating
                within the Out-of-Home advertising space. We understand the unique challenges sellers face in this
                fast-paced industry, and we're here to provide tools and support to help you succeed.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <p className="text-gray-700 text-lg mb-8">
            Ready to take your selling efforts to new heights on OHSHOP? Join the growing community of sellers who trust
            Sellah to streamline their operations and drive success in the OOH industry. Contact us today to schedule a
            demo or learn more about how Sellah can transform your business.
          </p>
